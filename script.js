...
power ? sounds.map(sound => /*#__PURE__*/React.createElement(KeyboardKey, { play: play, sound: sound })) :
sounds.map(sound => /*#__PURE__*/React.createElement(KeyboardKey, { play: play, sound: { ...sound, url: "#" } })));



const DumControler = ({ name, stop, power, volume, handleVolumeChange, changeSoundsGroup }) => /*#__PURE__*/
React.createElement("div", { className: "controler" }, /*#__PURE__*/
...
const App = () => {
  ...
  return /*#__PURE__*/(
    ...
    React.createElement(DumControler, {
      stop: stop,
      power: power,
      volume: volume,
